  ...
  parameters: {
    ...
    properties: {
      table: {
        type: "string",
        description:
          "Table name (ramp_transactions, ramp_bills, assistant_jobs, assistant_actions, sync_log, scheduled_tasks, dim_bu_mapping, agent_memories)",
      },
